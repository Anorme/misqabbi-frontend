...
const CtaSection = () => {
  const images = [
    ...
    {
      src: 'https://res.cloudinary.com/dyciw970t/image/upload/f_auto,q_auto,w_400,c_limit/v1762259821/CSI_0091_kpx9rz.jpg',
    ...
    {
      src: 'https://res.cloudinary.com/dyciw970t/image/upload/f_auto,q_auto,w_400,c_limit/v1762259811/CSI_0034_02_pfnol6.jpg',
      alt: 'African print skirt',
    },
  ];
