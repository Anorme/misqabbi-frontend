...
const AuthPromptModal = ({ onClose }) => {
  ...
  // Context-aware copy based on triggering route
  const getContextualCopy = () => {
    const currentPath = location.pathname;

    // Check if user was trying to access wishlist
    if (currentPath.includes('/wishlist') || currentPath.includes('/favorites')) {
      return {
    ...
    // Default copy for other protected routes
    return {
      heading: 'Welcome to your style journey! ✨',
      message:
        'Sign in to access your personalized shopping experience, save your favorites, and track your orders.',
      primaryButton: 'Log In',
      secondaryButton: 'Create Account',
      tertiaryButton: 'Keep Browsing',
    };
  ...
  return (
    <div className="fixed inset-0 bg-transparent bg-opacity-30 z-50 flex items-center justify-center p-4">
